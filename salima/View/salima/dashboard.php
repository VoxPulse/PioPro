            ...
            var calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                eventClick: function (info) {
                    ...
                    $('#popupDetails').html(
                        ...
                        `<p><strong>ID du guide :</strong> ${excursionDetails.guide}</p>` +
                        `<p><strong>Destination :</strong> ${excursionDetails.destination}</p>` +
                        `<p><strong>Durée :</strong> ${excursionDetails.duree}</p>` +
                        `<p><strong>Date de début :</strong> ${excursionDetails.deb}</p>` +
                        `<p><strong>Date de fin :</strong> ${excursionDetails.fin}</p>` +
                        `<p><strong>Prix :</strong> ${excursionDetails.prix}</p>` +
                        `<p><strong>Capacité :</strong> ${excursionDetails.capacite}</p>` +
                        `<p><strong>Activité :</strong> ${excursionDetails.activite}</p>`
                    );
                        ...
                        <div class="card">
                            <div class="card-body p-3">
                                <div class="row">
                                    <div class="col-8">
                                        <div class="numbers">
                                            <p class="text-sm mb-0 text-uppercase font-weight-bold">participants pour le
                    ...
                    <div class="card">
                        ...
                        <div class="card-header pb-0 p-3">
                            ...
                            <div class="input-group mb-3">
                                <form action="" method="get">
                                    <input type="text" class="form-control" id="tri" name="tri"
                                        placeholder="Ecrivez le titre" style="width: 100%;">
                                </form>
                            </div>
                            ...
                            <div class="input-group mb-3">
                                <div class="controls">
                                    <form action="" method="get">
                                        <select id="tri1" name="tri1" class="form-control"
                            ...
                            <div class="table-responsive">
                                <table class="table align-items-center">
                                    <button type="Submit"
                                        class="btn btn-link text-dark p-0 fixed-plugin-close-button">Trier</button>
                                    <tbody>
                                        <?php
    ...
    <script>
        $(document).ready(function () {
            $('#ID').change(function () {
                ...
                $.ajax({
                    type: 'POST',
                    url: 'C:\wamp64\www\PROJET\VoxPulse\View\salima\update_nombre_de_place.php',
                    data: {
                        id: selectedID
                    },
                ...
                <form action="UpdateParticipation.php" method="post" id="FORM7">
                    <div class="form-row">
                        <div class="form-column">
                            ...
                            <div class="form-group">
                                <label for="PRENOM">Prenom:</label>
                                <div id="prenom2Error" class="invalid-feedback">Le prénom doit contenir que des lettres!
                                </div>
                                <input type="text" id="PRENOM" name="PRENOM">
                            </div>
                            <div class="form-group">
                                <label for="EMAIL">Email:</label>
                                <div id="email2Error" class="invalid-feedback">L'email doit respecter la forme des
                                    emails!</div>
                                <input type="text" id="EMAIL" name="EMAIL">
                            </div>
                            <div class="form-group">
                                <label for="TEL">Tel:</label>
                                <div id="tel2Error" class="invalid-feedback">Le numéro de téléphone doit contenir
                                    seulement des chiffres!</div>
                                <input type="text" id="TEL" name="TEL">
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="ETABLISSEMENT">Etablissement:</label>
                        <div id="etablissement2Error" class="invalid-feedback">L'établissement ne doit pas contenir des
                            caractères spéciaux!</div>
                        <input type="text" id="ETABLISSEMENT" name="ETABLISSEMENT">
                    </div>
                    <div class="form-group">
                        <label for="description">description:</label>
                        <div id="description2Error" class="invalid-feedback">La description doit contenir que des
                            lettres </div>
                        <input type="text" id="description" name="description">
                    </div>
                    <div class="form-group">
                        <label for="Id_Event">Id_Event:</label>
                        <div id="Id_Event2Error" class="invalid-feedback">Le numéro de téléphone doit contenir seulement
                            des chiffres!</div>
