...
<body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="container-fluid">
        <div class="d-flex align-items-center justify-content-between">
          <div class="d-flex align-items-center">
            <img src="./images/logo 1.png" alt="Description de votre image" width="50" height="50"
          ...
          <div class="mx-auto text-center" style="max-width: 2000px;">
            <nav class="site-navigation position-relative text-left" role="navigation">
              <ul class="site-menu main-menu js-clone-nav mx-auto d-none d-lg-block m-0 p-0 text-center">
                ...
                <li class="nav-item dropdown">
                  <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false" style="color: chartreuse;">Coaching</a>
          ...
          <div class="ml-auto">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu main-menu site-menu-dark js-clone-nav mr-auto d-none d-lg-block m-0 p-0">
                <li class="cta"><a href="../sign-in.html" class="nav-link"
                    style="color: chartreuse;"><span>Connexion</span></a></li>
              </ul>
            </nav>
            ...
            <div class="col-12">
              <div class="row align-items-center">
                <div class="col-lg-6 mb-4">
                  ...
                  <p class="mb-4" data-aos="fade-up" data-aos-delay="200"><b>Chez PioPo Du Début au pro , nous avons ce
                      qu'il vous faut</b></p>
                  <p data-aos="fade-up" data-aos-delay="300"><a href="#"
                      class="btn btn-primary py-3 px-5 btn-pill">S'abonner Mainetenant</a></p>
    ...
    <div class="site-section courses-entry-wrap" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row">
          ...
          <div class="owl-carousel col-12 nonloop-block-14">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <a href="course-single.html"><img src="./images/parents-with-baby-pointing-laptop-screen.jpg"
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <a href="course-single.html"><img src="./images/handshake-close-up-cadres.jpg" alt="Image"
                    class="img-fluid"></a>
              </figure>
              <div class="course-inner-text py-4 px-4">
            ...
            <div class="course bg-white h-100 align-self-stretch">
              <figure class="m-0">
                <a href="course-single.html"><img src="./images/we-are-hiring-digital-collage.jpg" alt="Image"
                    class="img-fluid"></a>
              </figure>
              <div class="course-inner-text py-4 px-4">
      ...
      <div class="row justify-content-center">
        <div class="col-7 text-center">
          <button href="open_folder.php" target="_blank" class="customNextBtn btn btn-primary m-1">Appuyez pour une
            expérience inoubliable!</button>
        </div>
      </div>
    </div>
  </div>
        ...
        <div class="owl-carousel col-12 nonloop-block-14">
          ...
          <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
              ...
              <p>
                ...
                Description :
                Nous recherchons un Manager des Ventes dynamique pour diriger notre équipe de vente et atteindre nos
                objectifs de croissance. Expérience en gestion des ventes requise. Postulez maintenant ! </p>
            </div>
            <div class="d-flex border-top stats">
          ...
          <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
              ...
              <p>Titre du poste : Support Technique Help Desk
                ...
                Description :
                Rejoignez notre équipe en tant que Support Technique Help Desk. Aucune expérience préalable requise.
                Formation complète fournie. Postulez maintenant !</p>
            </div>
            <div class="d-flex border-top stats">
          ...
          <div class="course bg-white h-100 align-self-stretch">
            ...
            <div class="course-inner-text py-4 px-4">
              ...
              <p>"Cours de conception de logo : Créez des logos mémorables en explorant le design graphique, la
                typographie et la couleur. Apprenez des techniques de conception, des croquis à la finalisation
                professionnelle." </p>
            </div>
            <div class="d-flex border-top stats">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="owl-carousel col-12 nonloop-block-14">
          ...
          <div class="course bg-white h-100 align-self-stretch">
            <figure class="m-0">
              <a href="course-single.html"><img src="./images/Tara_Lets-Teach-about-Body-Language_Banner.png"
                  alt="Image" class="img-fluid"></a>
            </figure>
            <div class="course-inner-text py-4 px-4">
          ...
          <div class="course bg-white h-100 align-self-stretch">
            <figure class="m-0">
              <a href="course-single.html"><img src="images/C-Programming-Language.png" alt="Image"
                  class="img-fluid"></a>
            </figure>
            <div class="course-inner-text py-4 px-4">
              <span class="course-price">$99</span>
    ...
    <div class="container">
      ...
      <div class="row justify-content-center">
        <div class="col-md-7">
          ...
          <p class="mb-5">Nous sommes là pour vous aider ! N'hésitez pas à nous contacter pour toute question,
            commentaire ou demande d'assistance. Remplissez simplement le formulaire ci-dessous et nous vous répondrons
            dans les plus brefs délais. Votre satisfaction est notre priorité.</p>

          <form method="post" action="ADDPARTICP2.php">

            <div class="form-group row">
              <div class="col-md-6">
                <input type="text" name="nom" class="form-control" placeholder="Nom" required pattern="[A-Za-z]{1,}">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                <input type="text" name="tel" class="form-control" placeholder="Numero de téléphone" required
                  pattern="[0-9]{8}">
            ...
            <div class="form-group row">
              <div class="col-md-12">
                <select class="form-control" name="event_id" id="event-select">
                  <?php
                  // Inclure le fichier où se trouve la méthode getAllEventTitlesAndIds()
                  include 'C:\wamp64\www\PROJET\VoxPulse\Controller\eventC.php';

                  $E = new eventC;

                  // Appeler la méthode pour récupérer les titres et les IDs des événements
                  $eventData = $E->getAllEventTitlesAndIds();

                  // Afficher les titres des événements dans les options du select, tout en associant les IDs
                  foreach ($eventData as $event) {
                    echo "<option value='" . $event['id'] . "'>" . $event['titre'] . "</option>";
                  }
                  ?>
                </select>
              </div>
            ...
            <script src="validation.js"></script> <!-- Inclure le fichier JavaScript ici -->
            <div class="form-group row">
              <div class="col-md-6">
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      //Modification
      var slimOverlay = document.querySelector('.salima');
    ...
    <div class="container">
      ...
      <div class="row mb-5 justify-content-center">
        <div class="col-lg-7 mb-5 text-center" data-aos="fade-up" data-aos-delay="">
          ...
          <p class="mb-5">Les avis des utilisateurs sont les retours d'expérience partagés par ceux ayant utilisé nos
            offres de travail et formations. Ils fournissent un aperçu authentique des impressions et de la satisfaction
            des utilisateurs, aidant ainsi d'autres à prendre des décisions éclairées.</p>
        </div>
      </div>
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="100">
          <div class="teacher text-center">
            ...
            <div class="py-2">
              ...
              <p>Je suis absolument ravi de mon expérience avec cette société ! Leurs offres d'emploi sont variées et
                pertinentes, et j'ai trouvé le poste parfait grâce à leur plateforme. De plus, leurs formations sont
                exceptionnelles ; j'ai acquis de nouvelles compétences qui m'ont vraiment aidé à avancer dans ma
                carrière. Je recommande vivement leurs services à tous ceux qui cherchent à progresser
        ...
        <div class="col-md-6 col-lg-4 mb-4" data-aos="fade-up" data-aos-delay="300">
          <div class="teacher text-center">
            ...
            <div class="py-2">
              ...
              <p>Excellent service ! Grâce à leurs offres d'emploi et formations, j'ai trouvé rapidement un emploi qui
                correspond à mes compétences et à mes intérêts.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center align-items-center">
        <div class="col-md-8 text-center testimony">
          ...
          <blockquote>
            <p>Je suis incroyablement reconnaissant envers cette plateforme ! Grâce à eux, j'ai immédiatement trouvé un
              emploi correspondant à mes compétences dès ma sortie de l'université. Une transition sans heurts vers ma
              carrière, merci infiniment !</p>
          </blockquote>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-4">
          ...
          <p>PIOPRO, votre partenaire pour l'évolution professionnelle. Des formations pratiques conçues pour vous aider
            à acquérir de nouvelles compétences et à accéder à des opportunités d'emploi passionnantes. Transformez
            votre carrière avec nous dès maintenant.</p>
        </div>
        ...
        <div class="col-md-4">
          <h3>NewsLetter</h3>
          <p>Abonnez-vous à notre newsletter pour rester informé(e) des dernières actualités, des offres exclusives et
            des événements à venir. Rejoignez notre communauté dès aujourd'hui et ne manquez aucune opportunité de
        ...
        <div class="col-md-12">
          <div class="border-top pt-5">
            <p>
              ...
              Copyright &copy;
              <script>document.write(new Date().getFullYear());</script> Tous droits réservés | Ce modèle est réalisé
              avec PIO-PRO
              <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
          </div>
