                                ...
                                <div class="card-body">
                                    <form id="myForm"  method="post">
                                        <div class="mb-3">
                                            ...
                                            <input type="MDP" id="MDP" name="MDP" class="form-control form-control-lg" placeholder="Mot de Passe " aria-label="Email">
                                            <div id="MailEnvoy" class="invalid-feedback">
                                                Mail envoyé
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            ...
                                            <input type="MDP2" id="MDP2" name="MDP" class="form-control form-control-lg" placeholder="Confirmez Votre Mot de passe  " aria-label="Email">
                                            <div id="MailEnvoy" class="invalid-feedback">
                                                Mail envoyé
                                            </div>
                                        </div>
