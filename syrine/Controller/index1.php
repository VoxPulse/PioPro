      ...
      <div class="welcome-demop102 text-center">
        ...
        <div class="form-container" id="questionForm1">
          <?php
              if(isset($_GET['id']))
              {
                require_once('C:\wamp64\www\VoxPulse4\Controller\offre_emploiC.php');
                $offre=new offre_emploiC();
                $id = $_GET['id'];
                $row = $offre->getoffre_emploiById($id);
                if ($row !== false) 
                {
                    ...
                    <button style="background-color: #4CAF50; color: white; border: none; padding: 10px 20px; cursor: pointer; border-radius: 5px;">
                        <a href="delete_offre_emploi.php?id='.$id .'" style="color: inherit; text-decoration: none;">Supprimer</a>
                    </button>'
                    ;
                } 
                else 
                {
                    echo "offre_emploi not found.";
                }
              }  
          ...
          <form action="submit_offre_emploi.php?<?php if (isset($id)){echo "id=update";} ?>" method="POST" id="publier">
           <input type="hidden" name="id" value="<?php if (isset($id)){echo $_GET['id'];}?>">
            <div class="userId-part940">
                ...
                <input type="text" name="id" id="form_id" class="username029" placeholder="Entrez ID" value="<?php if (isset($id)){echo $id;}?>"  <?php if (isset($id)) { echo 'readonly'; } ?> >  
                <span id="form_user_idError" class="error"></span>
            </div>
            <div class="question-title39">
                <span class="form-description43">titre_p* </span>
                <input type="text" name="titre_p" id="form_titre_p" class="question-ttile32" placeholder="Entrez le titre_p de votre offre_emploi" value="<?php if (isset($id)){echo $titre_p;}?>">
                <span id="form_titre_pError" class="error"></span>
            </div>
            <div class="details2-239">
              <span class="form-description43">description* </span>
              <textarea id="txtEditor" class="big-textarea" name="description" id="form_description"><?php if (isset($id)){echo $description;}?></textarea>
              <span id="form_descriptionError" class="error"></span>
            </div>
            <div class="details2-239">
              <span class="form-description43">date fin* </span>
              <textarea id="txtEditor" class="big-textarea" name="description" id="form_description"><?php if (isset($id)){echo $date_fin;}?></textarea>
              <span id="form_descriptionError" class="error"></span>
            </div>
            <div class="details2-239">
              <span class="form-description43">salaire* </span>
              <textarea id="txtEditor" class="big-textarea" name="description" id="form_description"><?php if (isset($id)){echo $salaire;}?></textarea>
              <span id="form_descriptionError" class="error"></span>
            </div>	
            <div class="details2-239">
              <span class="form-description43">categorie* </span>
              <textarea id="txtEditor" class="big-textarea" name="description" id="form_description"><?php if (isset($id)){echo $categorie;}?></textarea>
              <span id="form_descriptionError" class="error"></span>
            </div>		
                      ...
                      <div id="que-hedder2983">
                        <h3>
                          <a href="post-deatils.html" target="_blank"
                            >Why Do You Want to Work at This Company?</a
                          >
                        </h3>
                      </div>
              ...
              <div class="question-type2033">
                <div class="row">
                  <div class="col-md-1">
                    <div class="left-user12923 left-user12923-repeat">
                      <a href="#"
                        ><img src="image/images" alt="image" />
                      </a>
                      <a href="#"
                        ><i class="fa fa-check" aria-hidden="true"></i
                      ></a>
