                    ...
                    <div class="right-description893">
                        ...
                        <form action="submit_comment.php' . ((isset($_GET['edit_comment']) && $_GET['edit_comment'] == $rowCom['id']) ? '?id=update' : '') . '#postSection' . $uniqueId . '" method="POST" id="pubComment' . $uniqueId . '" enctype="multipart/form-data">';
                            ...
                            <div class="input-group">
                                <input type="text" name="form_comment_id_user" id="form_comment_id_user'.$uniqueId.'" value="'.($_SESSION['user']['id']) .'" ;';if ((isset($_GET['edit_comment']))&& ($_GET['edit_comment']== $rowCom['id'])&&($_GET['edit_comment_pub'] == $row['id'])){echo 'value="'.$id_user_comment.'"';} if (isset($id_user_comment)) { echo 'readonly'; }echo'>';
                                echo '
