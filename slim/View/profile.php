...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="./img/">
      ...
      <div class="row">
          ...
          <div class="card">
            <div class="card-header pb-0">
              <div class="d-flex align-items-center">
                <p class="mb-0">Modifier Profil</p>
              </div>
            </div>
            <div class="card-body">
        ...
        <div class="col-md-4">
          <div class="card card-profile">
            <img src="./oneschool-master/images/7984bfce-6397-4b53-a81b-ff5f5fcc4fba-768x323.jpeg" alt="Image placeholder" class="card-img-top">
            <div class="card-body pt-0">
              <div class="row">
                <div class="col">
                  <div class="d-flex justify-content-center">
                    <div class="d-grid text-center">
                      <span class="text-lg font-weight-bolder">Formez-vous gratuitement dès aujourd'hui !</span>
                    </div>
                  </div>
                </div>
              </div>
              <div class="text-center mt-4">
                <div class="h6 mt-4">
                  <i class="ni business_briefcase-24 mr-2"></i>Acquérez les compétences essentielles pour votre succès professionnel.
                  Inscrivez-vous maintenant - places limitées !
                </div>
                <div>
                  <i class="ni education_hat mr-2"></i>Remote
                </div>
              </div>
            </div>
          </div>
