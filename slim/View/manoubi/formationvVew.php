...
<?php
    require_once 'C:\wamp64\www\VoxPulse\Controller\contenueC.php';
    require_once 'C:\wamp64\www\VoxPulse\Controller\formationC.php';
    ...
    $tableHTMLC = '<table class="table">';
    $tableHTMLC .= '<thead>';
    $tableHTMLC .= '<tr>';
    $tableHTMLC .= '<th>ID</th>';
    $tableHTMLC .= '<th>description</th>';
    $tableHTMLC .= '<th>duree</th>';
    $tableHTMLC .= '<th>prix</th>';
    $tableHTMLC .= '<th>image</th>';
    $tableHTMLC .= '</tr>';
    $tableHTMLC .= '</thead>';
    $tableHTMLC .= '<tbody>';
    foreach ($resultat as $row)
    {
        $tableHTMLC .= '<tr>';
        $tableHTMLC .= '<td>' . $row['id'] . '</td>';
        $tableHTMLC .= '<td>' . $row['description'] . '</td>';
        $tableHTMLC .= '<td>' . $row['duree'] . '</td>';
        $tableHTMLC .= '<td>' . $row['prix'] . '</td>';
        $tableHTMLC .= '<td>' . $row['image'] . '</td>';
        $tableHTMLC .= "<td > <a class='btn btn-danger btn-supprimer' href='suprimerformation.php?id=" . $row['id']. "'>suprimer</a></td>" ;
        $tableHTMLC .= "<td > <a class='btn btn-primary' href='modifierFormationView.php?id=" . $row['id']. "'>modifier</a></td>" ;
        $tableHTMLC .= '</tr>';
    }
?>
<!DOCTYPE html>
          ...
          <div class="card">
            <div class="card-body p-3">
              <div class="row">
                <div class="col-8">
                  <div class="numbers">
                    <p class="text-sm mb-0 text-uppercase font-weight-bold">Nombre Des utilisateurs</p>
...
<div id="confirmationLabel" class="confirmation-label">
