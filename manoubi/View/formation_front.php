...
<html lang="en">
  ...
  echo '<div class="site-section courses-entry-wrap" data-aos="fade-up" data-aos-delay="100">';
    ...
    foreach ($resultat as $row) {
        ...
        echo '<h3><a href="#">' . $row['description'] . '</a></h3>';
        echo '<h3><a href="#" style="color:red;font-size: 3.5rem;">' . $row['type'] . '</a></h3>';
        echo '</div>';
        echo '<div class="d-flex border-top stats">';
        echo '<span class="course-price">' . $row['prix'] . ' dt</span>';
        echo "<td><a class='btn btn-primary' onclick='reinitMap(20 , 20 )'>Localisation</a></td>";
